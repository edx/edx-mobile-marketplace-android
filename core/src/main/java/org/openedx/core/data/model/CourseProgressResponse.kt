...
data class CourseProgressResponse(
    @SerializedName("verified_mode") val verifiedMode: VerifiedMode?,
    @SerializedName("access_expiration") val accessExpiration: AccessExpiration?,
    ...
    fun mapToDomain(): CourseProgress {
        return CourseProgress(
            verifiedMode = verifiedMode?.sku ?: "",
            accessExpiration = accessExpiration?.expirationDate ?: "",
    ...
    fun mapToRoomEntity(courseId: String): CourseProgressEntity {
        return CourseProgressEntity(
            courseId = courseId,
            verifiedMode = verifiedMode?.sku.orEmpty(),
            accessExpiration = accessExpiration?.expirationDate.orEmpty(),
...
data class VerifiedMode(
    @SerializedName("access_expiration_date") val accessExpirationDate: String?,
    @SerializedName("currency") val currency: String?,
    @SerializedName("currency_symbol") val currencySymbol: String?,
    @SerializedName("price") val price: Int?,
    @SerializedName("sku") val sku: String?,
    @SerializedName("upgrade_url") val upgradeUrl: String?
)
data class AccessExpiration(
    @SerializedName("expiration_date") val expirationDate: String?,
    @SerializedName("masquerading_expired_course") val masqueradingExpiredCourse: Boolean?,
    @SerializedName("upgrade_deadline") val upgradeDeadline: String?,
    @SerializedName("upgrade_url") val upgradeUrl: String?,
