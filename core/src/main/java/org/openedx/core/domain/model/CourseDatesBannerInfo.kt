...
enum class CourseBannerType(
    ...
    BLANK,
    INFO_BANNER(
        headerResId = R.string.core_dates_info_banner_header,
    ...
    UPGRADE_TO_RESET(
        headerResId = R.string.core_dates_upgrade_to_reset_banner_header,
        bodyResId = R.string.core_dates_upgrade_to_reset_banner_body
    ),
    RESET_DATES(
