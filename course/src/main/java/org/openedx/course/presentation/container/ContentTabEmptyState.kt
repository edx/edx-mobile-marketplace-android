    ...
    Column(
        ...
        if (showReturnButton) {
            ...
            OpenEdXBrandButton(
                ...
                IconText(
                    text = stringResource(id = org.openedx.core.R.string.course_return_to_course_home),
...
fun CourseHomeGradesEmptyState(
    ...
    ContentTabEmptyState(
        modifier = modifier,
        message = stringResource(id = org.openedx.core.R.string.course_progress_no_assignments),
