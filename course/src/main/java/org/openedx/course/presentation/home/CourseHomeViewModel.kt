...
class CourseHomeViewModel(
    ...
    private fun getCourseDataInternal() {
        viewModelScope.launch {
            ...
            try {
                val debugStructureFlow = courseStructureFlow
                    .onEach { Log.d("FLOW", "STRUCTURE EMITTED") }

                val debugStatusFlow = courseStatusFlow
                    .onEach { Log.d("FLOW", "STATUS EMITTED") }

                val debugDatesFlow = courseDatesFlow
                    .onEach { Log.d("FLOW", "DATES EMITTED") }

                val debugProgressFlow = courseProgressFlow
                    .onEach { Log.d("FLOW", "PROGRESS EMITTED") }
                combine(
                    debugStructureFlow,
                    debugStatusFlow,
                    debugDatesFlow,
